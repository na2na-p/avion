...
*   **通知生成**: 18種類の通知タイプに対応し、各通知の優先度・配信チャネル・グループ化ルールを適切に適用すること
...
*   **Phase 1**: Notification/NotificationEvent Aggregateの実装、PostgreSQLスキーマ作成（UUID v7によるID生成）、NATS JetStreamイベント購読基盤、基本的な通知CRUD API。リリース基準: カバレッジ90%以上。
